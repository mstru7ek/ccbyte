...
import com.mstruzek.ccbyte.attribute.typeant.target.catch_target;

@Discriminator(range = @Range(from = 0x42, to = 0x42))
public class catch_target_annotation extends type_annotation {
  public catch_target target_info;
